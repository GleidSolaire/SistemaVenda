...
public class Console {
	...
	public static int mostrarMenu(String[] opcoes, String titulo, String descricao) {
		...
		try {
			...
			opcaoEscolhida = mostrarMenu(opcoes, "Voce selecionou uma opcao invalida, por favor tente novamente.",
					descricao);
		}
	...
	public static void MensagemGenericaErro () {
		...
		System.out.println("Valor duplicado, não é possível cadastrar");
	}
